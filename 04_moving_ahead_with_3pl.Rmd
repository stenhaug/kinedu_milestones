...
items_3pl_1 %>% filter(a1 < 0.25 | a1 > 5) %>% arrange(desc(abs(a1))) %>% View()
...
items_3pl_1 %>% mutate(r = row_number()) %>% filter(item == "conver_617")

itemplot(mod_3pl_1, 1)
