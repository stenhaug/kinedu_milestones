...
results <-
	bind_rows(read_rds(here("02_mirts_2_add_5.rds")), read_rds(here("02_bifactors.rds"))) %>%
...
age_partitioned_models <- read_rds(here("data-models", "age_partitioned_models.rds"))
